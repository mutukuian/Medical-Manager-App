...
fun SignOutBtn(
    ...
    // Capture navController before launching the coroutine
    ...
    Button(
        onClick = {
            scope.launch {
                viewModel.signOut()
                // Use the captured navController for navigation
                localNavController?.navigate(Screen.RegisterScreen.route){
